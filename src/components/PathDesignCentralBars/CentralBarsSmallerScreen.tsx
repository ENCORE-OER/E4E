...
export default function CentralBarsSmallerScreen({
    ...
    return (
        <Flex paddingTop="1.5rem" w="100%" direction={isSmallerScreen ? 'column' : 'row'}>
            <Flex flexDirection={isSmallerScreen ? 'row' : 'column'} flex="1" w="100%" pr={`${SPACING}%`} gap={`${SPACING}%`}>
            ...
            <Box flex="1" flexDirection='column' w="100%" pr={`${SPACING}%`} pt={`${SPACING}%`}>
                <Text
                    fontSize="sm"
                    fontWeight="bold"
