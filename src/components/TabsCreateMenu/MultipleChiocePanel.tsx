...
export default function MultipleChoicePanel({ isSmallerScreen }: MultipleChoicePanelProps) {
    ...
    return (
        <>
            ...
            <Flex paddingTop="3rem" w="40%">
                <Button size='lg' colorScheme='yellow' border="solid 1px" borderRadius="lg">
                    <Text as="b">
                        Generate
                    </Text>
                </Button>
