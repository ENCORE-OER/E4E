...
export default function TagSelectedResource({
    ...
    return (
        <Tag bg='white' border="1px solid lightgrey" w="fit-content" gap={1} borderRadius={20}>
            ...
            >
                <Flex direction="row" align="center">
                    <Icon as={IconTag} />
                    <TagLabel w="fit-content" maxW="100px" noOfLines={1}>{label}</TagLabel>
                    <Button size={"sm"} p={0} variant="ghost" onClick={handleClick}><MdOutlineCancel fontSize={"x-large"} color="grey" /></Button>
                </Flex>
            </Tooltip>
        </Tag>
    );
