            ...
            >
                ...
                {index !== undefined &&  // use index to check if the checkbox should be displayed: that means that we are in the 'learning objectives page'
                    <Checkbox
                        ...
                        color={'black'}
                        borderRadius='md'
                        isChecked={selectedLO && index !== undefined ? selectedLO[index] : false}   //TODO: reset the checkbox after clicking the generate buttons                   
                        onChange={handleCheckBoxClick && index !== undefined ? () => handleCheckBoxClick(index) : undefined}
                    />
                }
            </Box>

            <EditButtonLearningObjectiveBox isEditClicked={isEditClicked} handleEditClick={handleEditClick} />
        </Flex>
    );
}