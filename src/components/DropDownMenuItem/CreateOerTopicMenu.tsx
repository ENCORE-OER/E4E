    ...
    return (
        <>
            <Menu isLazy>
                ...
                <MenuList width="auto">
                    {hydrated &&
                        data?.MainTopics.slice(0, data.Language !== 'English' ? data.MainTopics.length / 2 : undefined).map((topicItem, index) => (
                            <MenuItem key={index} onClick={() => handleTopicSelect(topicItem.Topic, index)}>
