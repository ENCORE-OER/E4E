...
export default function BodyQuizOrQuestion({
  ...
  return (
    ...
    <Flex justifyContent={'left'} overflowWrap={'normal'} direction="column">
      ...
      {options && options.length > 0 && (
        ...
        >
          ...
          <Text variant="label_drawer">Number of Easy Distractors</Text>
          <Text pb="5">{n_o_ed}</Text>
          <Text variant="label_drawer">Number of Correct Answers</Text>
