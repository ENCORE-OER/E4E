import { Box, BoxProps, Flex, Heading, Icon, Spacer, Text } from "@chakra-ui/react";
...
export default function CollectionView({ collections, collectionIndex, oersById, ...rest }: CollectionViewProps) {
    return (
        <Box {...rest}>
            <Flex w="100%" mb="3">
