          ...
          <Flex direction="column" gap={0.5} pt={1}>
            {showBox &&
              ...
              lesson.passFailConditions?.map(
                (condition: PassFailConditionsProps, indexCondition: number) => (
                  <Flex direction="row" gap={3} align="center" key={indexCondition}>
                    <Flex
                      direction="row"
                      gap={1}
                      py={1}
                    ...
                    <UnderlinedButton
                      handleClick={() => { handleOpenModal !== undefined && indexCard !== undefined && handleOpenModal(indexCard, indexCondition) }}
                      nameButton="Change"
                      fontWeight="normal"
                    />
                  </Flex>
        ...
        <Flex direction={'row'} w="100%" align="center">
          ...
          <Flex direction="row" gap={3} flex="1" justify="flex-end">
            <AddPassFailConditionsButton
              handleOpenModal={() => { handleOpenModal !== undefined && indexCard !== undefined && handleOpenModal(indexCard, null) }}
