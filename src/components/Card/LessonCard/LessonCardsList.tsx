...
export default function LessonCardsList({
        ...
        setLessonCards((prevLessonCards) =>
            prevLessonCards.map((card: LessonCardProps, idxCard: number) => {
                ...
                if (idxCard === indexLesson) {
                    const updatedConditions = [...(card.lesson?.passFailConditions || [])];
    ...
    const handleOpenModal = (indexCard: number, conditionIndex: number | null = null) => {
        ...
        if (conditionIndex !== null) {
            const conditionToEdit = lessonCards[indexCard].lesson.passFailConditions[conditionIndex];
