...
const getConfig = () => {
    ...
    const config: CustomTabConfigProps = [
        {
            label: (
                <AddContentTabLabel iconTab={IconGenerateAI} spacing={2} name="Generate with AI" />
            ),
            child: <TabGenerateAI />,
            pt: '3%',
        },
        {
            label: (
                <AddContentTabLabel iconTab={IconAttach} spacing={2} name="Attach OERs" />
            ),
            child: <TabAttachOERs />,
            pt: '3%',
        },
        {
            label: (
                <AddContentTabLabel iconTab={IconUpload} spacing={2} name="Upload files" />
            ),
