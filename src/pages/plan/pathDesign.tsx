            ...
            <Box ml="200px" py="115px" pl="40px" w="full" h="100vh" bg="background">
                <Box w="100%" h="100%">
                    ...
                    <Flex paddingTop="1.5rem" w="80%" justifyContent="left">
                        <Text>Based on the information provided this a potential learning objective and a suggested learning path. You have the flexibility to modify and customize both the description of the learning objective and the types and sequence of the proposed activities</Text>
                    </Flex>
