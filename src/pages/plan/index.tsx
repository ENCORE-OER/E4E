      ...
      <Box ml="200px" py="115px" pl="40px" w="full" h="100vh" bg="background">
        ...
        >
          <Text>
            ...
            desired level within the Bloom taxonomy and provide indications of
            the skills, concepts, and contextual information that need to be
            achieved
          </Text>
        </Flex>
        ...
        <Flex w="100%">
          <Box paddingRight="3%" w="27%">
            <CustomDropDownMenu initialTitle="Bloom Level" data={bloomLevels} />
          </Box>
